...
=== pace
~ vilmuth_fear = true
Vilmuth speaks up again, less boistrously than before.
...
===ship
~ vilmuth_neutral = true
As lord commander of this ship it is tradition to have you rename it. This incurs an enormous beauracratic and financial expense and has a side benefit of confusing everyone aboard.
